...
from sqlalchemy import desc, Column, String, Integer, Boolean, DateTime, ARRAY, ForeignKey
  ...
  try:
    ...
    try:
      if request.form['seeking_talent'] == 'y':
        seeking_talent = True
        descp = request.form['seeking_description']
    except:
      seeking_talent = False
      descp = '' 
    new_venue = Venue(
...
def edit_artist_submission(artist_id):
  ...
  # artist record with ID <artist_id> using the new attributes  
    ...
    if artist_data:
      ...
      setattr(artist_data, 'seeking_description', descp)
...
def edit_venue_submission(venue_id):
  ...
  # venue record with ID <venue_id> using the new attributes
    ...
    if venue_data:
      ...
      setattr(venue_data, 'seeking_description', descp)
